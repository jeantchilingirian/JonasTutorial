...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamppbGlua2lyaWFuIiwiYSI6ImNrOGFoOWF5aTAyOGozanF0Y2l2eThsM2cifQ.pVbss7N0HCc0d8YblDuEqg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updates succesfuly")); //location.assign('/account');
            }
...
var loginForm = document.querySelector('#abcd');
